...
this.log.error("********** Response code: " + responseCode );
...
this.log.error("********** SolrRequestNumRetries: " + solrRequestNumRetries );

this.log.error("********** execRequest QUERY exception: " + e.getMessage() );
}
            } else {
...
System.out.println("********** execRequest exception: " + e.getMessage() );
...
this.log.error( "~~~ ~~~~~~~~~~~~~~~ JSON info::::::  " + json );

        PostMethod post = new PostMethod(this.baseUrl + "/" + archive + "/update/json?wt=json");
        post.setRequestEntity(new StringRequestEntity(json, "application/json", "utf-8"));
        post.setRequestHeader("Content-type", "application/json; charset=utf-8");

        // Execute request
        try {
this.log.error("~~~ ~~~~~~~~~~~~~~~ post json request::::::  " + post );

            execRequest( post );
this.log.error( "~~~ ~~~~~~~~~~~~~~~ After execrequest::::::  " );
