...
public class RDFIndexer {
    ...
    public void execute() {
        ...
        if (config.mode.equals(Mode.NONE) == false) {
            ...
            try {
this.log.error("~~~~~~~~~~~~~~~~~~ config corename: " + config.coreName()  );

                this.solrClient.validateCore( config.coreName() );
this.log.error("~~~~~~~~~~~~~~~~~~ after config corename: " + config.coreName()  );

            } catch (IOException e) {
this.log.error("~~~~~~~~~~~~~~~~~~ config validation error: " + e.getMessage()  );
...
this.log.error("~~~~~~~~~~~~~~~~~~ purgeArchive ERROR::::::: " + e);
