...
//System.out.println(":::::::::::::::::::::");
        ...
        if (handleText(predicate, object))
            return;
        if (handleRole(statement, predicate, object)){ 
           return;
}
        ...
        if (handleIsPartOf(predicate, object))
            return;  
	if (handleDigitalSurrogats(predicate, object))
            return;       
    }
    
    private boolean handleDigitalSurrogats(String predicate, String object) {
        if ("http://schema.org/url".equals(predicate)) {
            addField(doc, "digital_surrogats", object);
            return true;
        }
        return false;
    }
...
//System.out.println("\n" + predicate + " ?? " + object + "\n");
    ...
    private boolean handleSubject(String predicate, String object) {
        if ("http://purl.org/dc/terms/#subject".equals(predicate)) {
    ...
    private boolean handleRole(Statement statement, String predicate, String object) {
...
//System.out.println(statement.getObject().getObject());
...
String id = getFirstField(object, "Identifier");
System.out.println(id);
if (id.length() > 0)
   addField(object, "Identifier", id);
